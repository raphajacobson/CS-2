...
def get_initials(first, middle, last):
    ...
    space = 0                                                                                                   #set variable "space" to 0
    for char in user_name:                                                                                      #for loop (for every character in user's name)
        if char == " ":                                                                                         #if a character in the user's name is a space
            space += 1                                                                                          #add one to the space value
    firsti = list(first)                                                                                        #creates variable "firsti" which makes the user's first name into a list
    lasti = list(last)                                                                                          #creates variable "lasti" which makes the user's last name into a list
    middlei = list(middle)                                                                                      #creates variable "middlei" which makes the user's middle name into a list
    if space == 0:                                                                                              #if the space count equals 0
        initials = firsti[0]                                                                                    #variable "initials" equals the first character in the user's first name
    elif space == 1:                                                                                            #if the space count equals 1
        initials = firsti[0], lasti[0]                                                                          #variable "initials" equals the first character in the user's first name and the first character in the user's last name
    elif space == 2:                                                                                            #if the space count equals 2
        initials = firsti[0], middlei[0], lasti[0]                                                              #variable "initials" equals the first character in the user's first name, middle name, and last name
    else:                                                                                                       #otherwise
        initials = firsti[0], middlei [0], lasti[0]                                                             #variable "initials" equals the first character in the user's first name, middle name, and last name

    return "".join(initials)                                                                                    #return the variable "initials" joined together
...
def remove_title(user_name):
    ...
    Returns:
        Name without title
    '''
    titles = ["Dr.", "Sir", "Ph.d", "Esq", "Mr.", "Mrs.", "Ms."]                                                #define variable "titles" as a list with all possible titles
    
    parts = list(split_name(user_name))                                                                         #create variable "parts" as the user's name split into a list at every space
    first_part = parts[0]                                                                                       #create variable "first_part" and define it as the first index of the "parts" list (the first word of the user's name)                  
    
    if first_part in titles:                                                                                    #if the user's first_word is in the "titles" list
        parts.remove(first_part)                                                                                #remove the title from the parts list
        user_name = parts                                                                                       #redefine user_name as the user's name without its title
    return " ".join(user_name)                                                                                          #return the user's name without a title
...
def main():                                                                                                         #define main function (where every function is called and executed)
    while True:
        ...
        if choice == "1":
            ...
            print(get_initials(first_name(user_name), middle_name(user_name), last_name(user_name)))
        elif choice == "0":
            print(remove_title(user_name))
        elif choice == "13":
